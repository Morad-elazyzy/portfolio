    ...
    <section className="container px-4 my-24 mx-auto grid gap-16 grid-col-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
      <div>
        ...
        <p className="text-lg text-gray-600">
          deep knowledge of ux/ui fundamentals and advanced design concepts such
          as(sketching, wireframing, prototyping...).
        </p>
        <button className="bg-fuchsia-800 text-xl mt-6 text-white rounded py-3 px-4">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600">
          ...
          js...) ,most of my projects build with react but i can work with other
          frameworks as well.
        </p>
        <button className="bg-fuchsia-800 text-xl mt-6 text-white rounded py-3 px-4">
          <Link href="/front-end" scroll={false}>
            View projects
          </Link>
        </button>
      </div>
